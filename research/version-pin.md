...
```pwsh
Get-FileHash `
  "<Steam>\steamapps\common\Farever\hlboot.dat", `
  "<Steam>\steamapps\common\Farever\libhl.dll", `
  "<Steam>\steamapps\common\Farever\heaps.hdll", `
  "<Steam>\steamapps\common\Farever\Farever.exe" `
