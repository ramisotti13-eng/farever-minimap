// Kiero-style D3D12 vtable hook. Identical to minimap-dll/d3d12_hook.cpp
// except for namespace and the overlay callbacks it dispatches to. See
// the minimap version for the detailed comments — same pattern.
...
bool discover_vtable_pointers(void** out_present, void** out_resize_buffers,
    ...
    wc.lpszClassName = L"dpsmeter_dummy";
